...
if __name__ == "__main__":
    ...
    # Data
    parser.add_argument('--train-data', type=str, default='ml_rev23_1000.npz',
                        help='Path to training data (.npz) with 3 classes (labels 1..3)')
    ...
    parser.add_argument('--random-state', type=int, default=2, help='Random seed')
    parser.add_argument('--n-jobs', type=int, default=-1, help='Parallel jobs')
    parser.add_argument('--verbose', type=int, default=1, help='Verbose')

    # Output
    parser.add_argument('--save_dir', type=str, default='.', help='Output folder path')
