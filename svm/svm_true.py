...
if __name__ == "__main__":
    ...
    # Data
    parser.add_argument('--train-data', type=str, default='synthetic_data/svm/true/true_rev2345.npz',
    ...
    # Output
    parser.add_argument('--save_dir', type=str, default='synthetic_data/svm/true', help='Output folder path')
